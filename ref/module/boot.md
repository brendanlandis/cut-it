...
**Files:** `Cut It/u_init.pd`, `Cut It/wire.sh`, `Cut It/main.pd`, `Cut It/main-dev.pd`, `Cut It/u_root.pd`, `Cut It/u_mother-stub.pd` · **Gate:** `test/check-all.sh` · **Bench:** `test/bench/display-bench.pd`
