#!/usr/bin/env python3
"""Generates tools/phase9-assert-drive.pd -- the timed driver for Phase 9's gate.
...
def main(path):
    ...
    txt(20, 1200,
        "⚠️ RUN IT THROUGH tools/phase9-assert.sh \\, never by hand. The gate rewrites "
...
if __name__ == "__main__":
    main(sys.argv[1] if len(sys.argv) > 1 else "tools/phase9-assert-drive.pd")
