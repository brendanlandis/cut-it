...
**Files:** `Cut It/g_oled.pd`, `Cut It/g_grid.pd`, `Cut It/g_led.pd`, `Cut It/u_net.pd` · **Gate:** `test/gate/display-assert.sh` · **Bench:** `test/bench/phase3-bench.pd`, `test/bench/phase4-bench.pd`, `test/bench/phase6-bench.pd`
