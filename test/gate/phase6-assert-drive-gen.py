...
txt(20, 20,
    ...
    "before each window so test/gate/phase6-assert.py knows what the frames arriving "
    "in that window are supposed to look like.", 110)
txt(20, 150,
    "RUN IT THROUGH test/gate/phase6-assert.sh \\, never by hand -- the whole point is "
