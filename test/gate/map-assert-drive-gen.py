...
SEQ = [
    ...
    # ⛔ THE diag DESTINATION, WHICH NO SHIPPED ROW NAMES YET. Its handler is
    # the same uniform non-zero spigot every other button destination uses, so
    # what this proves is that a table row really can reach it -- the allowlist
    ...
    (6400, "DIAG-RELEASE", ["\\; param gk-diag 0"], GAP),
]
QUIT_MS = 7200
