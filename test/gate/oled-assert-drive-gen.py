...
BLURB = ("oled-assert-drive -- GENERATED by oled-assert-drive-gen.py. Do not edit "
         "this file. It drives g_oled's four layers over the disp bus: a parameter "
         "and its TTL \\, five rows and a refused sixth \\, a modal \\, an alert "
         "outranking it \\, the longer fail TTL \\, and the two reserved selectors.")
...
if __name__ == "__main__":
    ...
    w, b, c = D.build(sys.argv[1], SEQ, tag="OLED",
                      taps=["oscOut", "disp", "err"], quit_ms=QUIT_MS,
