#!/usr/bin/env python3
"""Generates all four acceptance benches from tools/bench_steps.py.

    python3 tools/bench-gen.py
...
CW, LH = 7.0, 18.0          # must match tools/pd-layout-check.py
...
def build(phase, cfg):
    ...
    H = int(yy + 300)
    p.write("tools/phase%d-bench.pd" % phase, W, H, cfg.get("declare"))
